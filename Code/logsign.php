                       ...
                       <script src="https://cdn.lordicon.com/fudrjiwc.js"></script>
                         <lord-icon
                            ...
                            <form method="POST" action="logincontroller.php" id="logIn" class="input-group">
                                <input name="lusername" type="text" class="input-field" placeholder="UserName" required>
                                <input name="luserpass" type="password" class="input-field" placeholder="Password" required>
                            ...
                            <form method="POST" action="signupcontroller.php" id="Register" class="input-group">
                                ...
                                <input name="usermail" type="email" class="input-field" placeholder="E-Mail" required>
                                <input name="userpass" type="password" class="input-field" placeholder="Password" required>
